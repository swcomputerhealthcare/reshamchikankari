...
--> statement-breakpoint
-- Rename wallet_accounts to wallets:
...
--> statement-breakpoint
-- Rename withdrawal_requests to wallet_withdrawals:
...
--> statement-breakpoint
ALTER TABLE "coupon_usage" DROP CONSTRAINT "coupon_usage_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "orders" DROP CONSTRAINT "orders_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "payout_methods" DROP CONSTRAINT "payout_methods_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "wallet_transactions" DROP CONSTRAINT "wallet_transactions_wallet_id_wallet_accounts_id_fk";
--> statement-breakpoint
ALTER TABLE "wallet_transactions" DROP CONSTRAINT "wallet_transactions_user_id_user_id_fk";
--> statement-breakpoint
...
ALTER TABLE "product_images" ALTER COLUMN "public_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "coupon_usage" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "orders" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "payout_methods" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
ALTER TABLE "wallet_transactions" ALTER COLUMN "user_id" SET DATA TYPE uuid;--> statement-breakpoint
...
ALTER TABLE "product_images" ADD COLUMN "image_url" text;--> statement-breakpoint
...
ALTER TABLE "product_variants" ADD COLUMN "compare_at_price_paise" integer;--> statement-breakpoint
ALTER TABLE "product_variants" ADD COLUMN "inventory_quantity" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "order_items" ADD COLUMN "product_name_snapshot" text;--> statement-breakpoint
ALTER TABLE "order_items" ADD COLUMN "sku_snapshot" text;--> statement-breakpoint
ALTER TABLE "order_items" ADD COLUMN "variant_snapshot" text;--> statement-breakpoint
...
ALTER TABLE "orders" ADD COLUMN "wallet_amount_paise" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "refunds" ADD CONSTRAINT "refunds_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "refunds" ADD CONSTRAINT "refunds_wallet_transaction_id_wallet_transactions_id_fk" FOREIGN KEY ("wallet_transaction_id") REFERENCES "public"."wallet_transactions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "wallets" ADD CONSTRAINT "wallets_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "wallet_withdrawals" ADD CONSTRAINT "wallet_withdrawals_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "wallet_withdrawals" ADD CONSTRAINT "wallet_withdrawals_wallet_id_wallets_id_fk" FOREIGN KEY ("wallet_id") REFERENCES "public"."wallets"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "wallet_withdrawals" ADD CONSTRAINT "wallet_withdrawals_payout_method_id_payout_methods_id_fk" FOREIGN KEY ("payout_method_id") REFERENCES "public"."payout_methods"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "coupon_usage" ADD CONSTRAINT "coupon_usage_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payout_methods" ADD CONSTRAINT "payout_methods_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "wallet_transactions" ADD CONSTRAINT "wallet_transactions_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
