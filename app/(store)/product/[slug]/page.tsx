        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 sm:gap-16">
            ...
            <div className="md:col-span-5 space-y-8">
              ...
              <ProductActionPanel product={product} variants={product.variants} initialWishlisted={isWishlisted} />
                ...
                {product.fabric && (
                  <div className="space-y-3 border-t border-brand-black/5 pt-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-4 text-xs font-sans text-neutral-600">
                      <div><span className="font-bold text-brand-black">Fabric:</span> {product.fabric}</div>
                      <div><span className="font-bold text-brand-black">Color:</span> {product.color}</div>
                      <div><span className="font-bold text-brand-black">Length:</span> {product.length}</div>
                      <div><span className="font-bold text-brand-black">Neckline:</span> {product.neckline}</div>
                      <div><span className="font-bold text-brand-black">Sleeves:</span> {product.sleeves}</div>
                      <div><span className="font-bold text-brand-black">Occasion:</span> {product.occasion}</div>
                      <div className="sm:col-span-2"><span className="font-bold text-brand-black">Wash Care:</span> {product.washCare}</div>
                    </div>
                  </div>
                )}
